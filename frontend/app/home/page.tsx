					...
					<section className="flex flex-col md:flex-row items-center justify-between gap-12 py-12">
						<div className="w-full md:1/2">
							...
							<p className="text-lg text-blue-800 mb-6">
								...
								a variety of technologies, including React, Node.js, and
								MongoDB. I am always looking to learn new skills and improve my
								craft.
							</p>
							<div className="flex space-x-4">
								<button className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-6 rounded-md flex items-center">
									View Projects
								</button>
								{/* TODO: Add link to projects and contact */}
								<button className="border border-blue-600 text-blue-600 hover:bg-blue-50 py-2 px-6 rounded-md">
									Contact me
								</button>
							</div>
						</div>
